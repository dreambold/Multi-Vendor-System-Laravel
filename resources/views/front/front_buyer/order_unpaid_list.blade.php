        ...
        <div class="row ml-0 mr-0 mt-20">
            ...
            <div class="col-md-6 text-right">
                ...
                <div class="display-inline ml-20 top-align">
                    ...
                    <p class="font-10 color-blue mb-0 text-right">self : $ {{$order['discount_price_req']}}</p>
                    @endif
                    @if($order['discount_price_response']*1 !=0)
                    <p class="font-10 color-blue mb-0 text-right">seller : $ {{$order['discount_price_response']}}</p>
                    @endif
                ...
                <div class="display-inline ml-20 top-align">
                    <div class="row ml-0 mr-0">
                        <button class="visit-btn" data-order-id = "{{$order['id']}}" onclick = "discountBuyerProposal(this)">Consult</button>
                    </div>
                    <div class="row ml-0 mr-0">
