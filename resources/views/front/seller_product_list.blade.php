...
@section('content')
    <div class="container">
        <div class="navigation-desktop">
            <h1><a href="javascript:void(0);">{{$sellerInfo->getFullNameAttribute()}}' Products</a></h1>
        </div>
                            ...
                            <div class="col" onclick="location.href='{{url("front/product/".$product["id"])}}'">
                                <div class="dne-itemtile dne-itemtile-medium" itemscope="itemscope"
                                    ...
                                    <div class="dne-itemtile-detail" role="text">
                                        ...
                                        <span>
                                            <span class="itemtile-price-strikethrough">US $29.99 </span>
                                            <span class="aria-hide">Previous price: US $29.99</span>
                                            <span class="itemtile-price-default">| </span>
                                            <span class="itemtile-price-bold">70% off</span>
                                        </span>
                                        </div>
                                        <span>
