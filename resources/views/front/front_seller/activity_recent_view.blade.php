        ...
        <div class="row ml-0 mr-0">
            ...
            <div class="tab-content mt-10">
                <div class="tab-pane fade active in" id="activity">
                    ...
                    <form id = "searchForm" action = "{{url("front/my/seller/activity_recent_view")}}" >
                    ...
                    <div class="col-md-10 col-xs-12 pl-0 pr-0" id="recently">
                        ...
                        <div class="row border-left ml-0 mr-0">
                            @foreach($list as $item)
                                <div class="col-md-4 col-xs-6 border-bottom border-right pt-10 cursor" style = "height:224px ; overflow:hidden;" data-id = "{{$item['product']['id']}}" onclick = "goProductPage(this)">
