                ...
                <div class="tab-pane fade active in" id="activity">
                    ...
                    <div class="col-md-10 my-ebay-content col-xs-12 pl-0 pr-0 active">
                        <div class = "row ml-0 mr-0 mt-20">
                            <p class="header-gray mb-0">Complete Order</p>
                            <div class="bg-white-wrapper row ml-0 mr-0">
                                <div class="bg-white-wrapper">
                                    <span>Show:</span>
                                    <input type="radio" name = "state" value = "3,4" onclick = "searchOrderList(0)" class="ml-10 checkbox-inline mt-0" checked><span class="color-black">All items</span>
                                    <input type="radio" name = "state" value = "3" onclick = "searchOrderList(0)" class="ml-10 checkbox-inline mt-0"><span class="color-black">Check</span>
                                    <input type="radio" name = "state" value = "4" onclick = "searchOrderList(0)" class="ml-10 checkbox-inline mt-0"><span class="color-black">Complete</span>
                                </div>
                            </div>
