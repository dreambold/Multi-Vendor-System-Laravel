...
@section('content')
    <div class = "login-wrapper">
        <div class = "text-center">
            <h2 class = "title">Create an business account</h2>
        </div>
        <div class = "text-center">
            <span class = "font-16">go to the account?<a class = "color-blue" href = "{{url("/register")}}">create account</a></span>
        </div>
        <div id="notific">
        ...
        <div class = "row mt-10">
            <div class = "col-lg-6 col-xs-12" style = "border-right: 1px solid #e2e2e2;">
                ...
                <div class="form-group mt-10">
                    <input name = "bio" class="form-control input-border-bottom" placeholder="Bio">
